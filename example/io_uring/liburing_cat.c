/**
 * liburing is a higher level api of linux/io_uring
 * it is more convenient to write app use liburing than io_uring
*/
#include <fcntl.h>
#include <stdio.h>
#include <string.h>
...
int submit_read_request(char *file_path, struct io_uring *ring) {
    ...
    while (bytes_remaining) {
        ...
        void *buf;
        // malloc the buffer, address align 1024
    ...
    /* this one sqe can read all block, simmilar to rdma scater gatter entry read/write */
    /* Setup a readv operation */
    io_uring_prep_readv(sqe, file_fd, fi->iovecs, blocks, 0);
    /* Set user data, for later io_uring_cqe_get_data */
